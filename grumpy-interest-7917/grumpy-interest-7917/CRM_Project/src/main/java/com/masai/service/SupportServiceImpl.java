...
public class SupportServiceImpl implements SupportService{
	...
	public void viewIssue() throws SomethingWentWrong{
		...
		for(Issues i : list) {
			if(i.getCsr()==null) {
			System.out.println("Issue id : "+i.getId()+ "  |  " + "Customer_id : " + i.getCustomer().getId()+ "  |  "  + "Issue : " + i.getIssue()+ "  |  "  + "Status : " + i.getStatus()+ "  |  "  +"Assigned : "+ "NA");
	...
	public void replyToIssue(int id, Scanner sc) throws SomethingWentWrong {
		...
		System.out.println("Entery issue id to resolve");
		id = sc.nextInt();
